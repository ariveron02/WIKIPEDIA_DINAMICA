    ...
    <div class="container">
        ...
        <div class="row text-center g-3">
            <div class="col-6 col-md-3">
                <div class="p-4 bg-white border rounded shadow-sm hover-elevate">
            ...
            <div class="col-6 col-md-3">
                <div class="p-4 bg-white border rounded shadow-sm hover-elevate">
                    <i class="bi bi-mortaboard fs-1 mb-2"></i>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-md-6 text-center">
                <div class="p-5 border border-2 border-warning rounded-circle d-inline-block">
                    <span class="fs-1 fw-bold">WÁ</span>
                </div>
            </div>
        </div>
    </div>
