...
// Consulta artículos de la BD para combinar con localStorage
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark custom-navbar fixed-top">
        <div class="container">
            ...
            <a href="pagPrincipal.php" class="btn btn-warning btn-sm rounded-pill px-3 me-2">Artículos</a>
    ...
    <div class="container mt-5">
        ...
        <div id="favoritos-container" class="row g-3"></div>
